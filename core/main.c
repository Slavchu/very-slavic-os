...
#if VERY_BIG_SLAVIC_GREETING
const char greetings_to_traveler[] = C_B_YELLOW "======================================================\r\n"
                                                "                  VERY SLAVIC OS\r\n"
                                                "======================================================\r\n" C_RESET "In the beginning, Svarog forged the Firmware from\r\n"
                                                ...
                                                "======================================================\r\n" C_RESET;
#else
const char greetings_to_traveler[] = C_B_YELLOW "Perun welcomes the traveler to very slavic os\r\n" C_RESET;
#endif
